...
<section class="content pb-4 mt-3">
    <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group text-center mt-2 mb-3">
                                        <h5 class="font-weight-bold text-muted small text-uppercase">
                                            <i class="fas fa-image text-primary mr-1"></i> CẤU HÌNH HÌNH ẢNH
                                        </h5>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-group text-center mb-3">
                                        <h5 class="font-weight-bold text-muted small text-uppercase">
                                            <i class="fas fa-share-alt text-success mr-1"></i> LIÊN KẾT MẠNG XÃ HỘI
                                        </h5>
                                ...
                                <div class="col-md-12 mt-4">
                                    <div class="form-group text-center mb-3">
                                        <h5 class="font-weight-bold text-muted small text-uppercase">
                                            <i class="fas fa-desktop text-info mr-1"></i> THÔNG TIN WEB & SEO
                                        </h5>
            ...
            <div class="col-md-12">
                <form id="form-contact-page">
                    <div class="card custom-card">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-address-book text-success mr-2"></i>CẤU HÌNH TRANG LIÊN HỆ
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Tiêu đề trang</label>
                                        <input type="text" class="form-control" name="contact_page_title"
                                            placeholder="Liên hệ KaiShop"
                                            value="<?= htmlspecialchars((string) ($chungapi['contact_page_title'] ?? '')) ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Nhãn Email</label>
                                        <input type="text" class="form-control" name="contact_email_label"
                                            placeholder="Email hỗ trợ"
                                            value="<?= htmlspecialchars((string) ($chungapi['contact_email_label'] ?? '')) ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Nhãn SĐT/Zalo</label>
                                        <input type="text" class="form-control" name="contact_phone_label"
                                            placeholder="Số điện thoại / Zalo"
                                            value="<?= htmlspecialchars((string) ($chungapi['contact_phone_label'] ?? '')) ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Mô tả ngắn
                                            (Subtitle)</label>
                                        <textarea class="form-control" name="contact_page_subtitle" rows="2"
                                            placeholder="Hiển thị dưới tiêu đề trang liên hệ"><?= htmlspecialchars((string) ($chungapi['contact_page_subtitle'] ?? '')) ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <label class="font-weight-bold small text-uppercase">Ghi chú hỗ trợ</label>
                                        <textarea class="form-control" name="contact_support_note" rows="3"
                                            placeholder="Ví dụ: Hỗ trợ 24/7 qua Zalo, Telegram..."><?= htmlspecialchars((string) ($chungapi['contact_support_note'] ?? '')) ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form id="form-legal-pages">
                    <div class="card custom-card">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-file-contract text-warning mr-2"></i>CHÍNH SÁCH & ĐIỀU KHOẢN
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h5 class="text-primary font-weight-bold mb-3"><i
                                            class="fas fa-shield-alt mr-1"></i> TRANG CHÍNH SÁCH</h5>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Tiêu đề</label>
                                        <input type="text" class="form-control" name="policy_page_title"
                                            placeholder="Chính sách & Quy định"
                                            value="<?= htmlspecialchars((string) ($chungapi['policy_page_title'] ?? '')) ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Mô tả ngắn</label>
                                        <textarea class="form-control" name="policy_page_subtitle" rows="2"
                                            placeholder="Mô tả ngắn cho trang chính sách"><?= htmlspecialchars((string) ($chungapi['policy_page_subtitle'] ?? '')) ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Nội dung (HTML)</label>
                                        <textarea class="form-control" name="policy_content_html" rows="8"
                                            placeholder="<h2>...</h2><p>...</p>"><?= htmlspecialchars((string) ($chungapi['policy_content_html'] ?? '')) ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Thông báo cuối
                                            trang</label>
                                        <textarea class="form-control" name="policy_notice_text" rows="2"
                                            placeholder="Thông báo xác nhận"><?= htmlspecialchars((string) ($chungapi['policy_notice_text'] ?? '')) ?></textarea>
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <h5 class="text-info font-weight-bold mb-3"><i class="fas fa-gavel mr-1"></i> TRANG
                                        ĐIỀU KHOẢN</h5>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Tiêu đề</label>
                                        <input type="text" class="form-control" name="terms_page_title"
                                            placeholder="Điều khoản & Điều kiện"
                                            value="<?= htmlspecialchars((string) ($chungapi['terms_page_title'] ?? '')) ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Mô tả ngắn</label>
                                        <textarea class="form-control" name="terms_page_subtitle" rows="2"
                                            placeholder="Mô tả ngắn cho trang điều khoản"><?= htmlspecialchars((string) ($chungapi['terms_page_subtitle'] ?? '')) ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Nội dung (HTML)</label>
                                        <textarea class="form-control" name="terms_content_html" rows="8"
                                            placeholder="<h2>...</h2><p>...</p>"><?= htmlspecialchars((string) ($chungapi['terms_content_html'] ?? '')) ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="font-weight-bold small text-uppercase">Thông báo cuối
                                            trang</label>
                                        <textarea class="form-control" name="terms_notice_text" rows="2"
                                            placeholder="Thông báo xác nhận"><?= htmlspecialchars((string) ($chungapi['terms_notice_text'] ?? '')) ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent border-0 text-right">
                            <button type="submit" class="btn btn-primary shadow-sm px-4 font-weight-bold"
                                style="border-radius: 8px;">
                                <i class="fas fa-save mr-1"></i> LƯU CHÍNH SÁCH
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div class="col-lg-6">
                <form id="form-smtp">
                    <div class="card custom-card">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-envelope text-info mr-2"></i>CẤU HÌNH SMTP GMAIL
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="alert alert-info py-2" style="border-radius: 8px;">
                                <i class="fas fa-lightbulb mr-1"></i> <a
                                    ...
                                    class="font-weight-bold text-info">Lấy mật khẩu ứng dụng Google tại đây</a>
                            </div>
                            <div class="form-group">
                ...
                <form id="form-notification">
                    <div class="card custom-card mt-3">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-bell text-danger mr-2"></i>THÔNG BÁO WEBSITE
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="row">
            ...
            <div class="col-lg-6">
                <form id="form-bank">
                    <div class="card custom-card">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-university text-primary mr-2"></i>NGÂN HÀNG & KHUYẾN MÃI
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                ...
                <form id="form-maintenance">
                    <div class="card custom-card mt-3">
                        <div class="card-header border-0">
                            <h3 class="card-title text-uppercase font-weight-bold">
                                <i class="fas fa-tools text-secondary mr-2"></i>BẢO TRÌ HỆ THỐNG
                            </h3>
                        </div>
                        <div class="card-body pt-0">
                            <div class="custom-control custom-switch mb-3">
                                ...
                                <label class="custom-control-label font-weight-bold" for="maintenance_enabled">BẬT CHẾ
                                    ĐỘ BẢO TRÌ</label>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        <label class="small font-weight-bold">Bắt đầu</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-2">
                                        <label class="small font-weight-bold">Thời lượng (phút)</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-0">
                                        <label class="small font-weight-bold">Lời nhắn bảo trì</label>
                                        <textarea class="form-control form-control-sm" name="maintenance_message"
                                            rows="2"><?= htmlspecialchars((string) ($maintenanceConfig['message'] ?? '')) ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent border-0 text-right">
                            <button type="button" id="btn-clear-maintenance"
                                class="btn btn-outline-danger btn-sm shadow-sm mr-2 font-weight-bold"
                                style="border-radius: 8px;">
                                <i class="fas fa-times mr-1"></i> TẮT NGAY
                            </button>
                            <button type="submit" class="btn btn-primary btn-sm shadow-sm px-4 font-weight-bold"
                                style="border-radius: 8px;">
...
<script>
    $(document).ready(function () {
        ...
        handleFormSubmit('form-contact-page', 'update_contact_page');
        handleFormSubmit('form-legal-pages', 'update_legal_pages');
