    ...
    <div class="container-fluid">
        <div class="row">
            <?php if ($filterMode === 'none'): ?>
                <div class="col-12">
                    <div class="alert alert-warning mx-3 mx-md-0 shadow-sm border-0">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                        Bảng <code>orders</code> hiện chưa có cột <code>source_channel</code> hoặc <code>telegram_id</code>,
                        nên hệ thống chưa thể tách riêng đơn hàng tạo từ Telegram trên schema hiện tại.
                    </div>
                </div>
            <?php endif; ?>
                        ...
                        <div class="card custom-card bg-primary text-white shadow-sm"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                        <h6 class="text-white-50 small font-weight-bold text-uppercase mb-1">Tổng đơn
                                            Bot</h6>
                        ...
                        <div class="card custom-card bg-success text-white shadow-sm"
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                        <h6 class="text-white-50 small font-weight-bold text-uppercase mb-1">Doanh thu
                                            Bot</h6>
                                    ...
                                    <?php if (!empty($orders)): ?>
                                        <?php foreach ($orders as $o): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="font-weight-bold"><?= htmlspecialchars($o['product_name']) ?></span>
                                                </td>
