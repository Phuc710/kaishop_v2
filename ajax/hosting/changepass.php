...
$pass_host = 'PHN@'.random('0123456789qwertyuiopasdfghjlkzxcvbnmQEWRWROIWCJHSCNJKFBJWQ', 12);
// Thông tin rsl
...
if ($data['result'] == '1') {
    $check_pass = $connection->query("UPDATE `lich_su_mua_host` SET `mk_host` = '$pass_host' WHERE `id` = '".$idhost."' ");
    if($check_pass){
