        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách server</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-server-host.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm server</a>
                                    </div>
                                </div>
                                <div class="card-body">
