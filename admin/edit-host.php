...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $toz_host =  $connection->query("SELECT * FROM `lich_su_mua_host` WHERE `id` = '$id' ")->fetch_array();
}
?>
<?php
if (isset($_POST["submit"]))
{
  $create = mysqli_query($connection,"UPDATE `lich_su_mua_host` SET 
