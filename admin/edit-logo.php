...
{
  $create = mysqli_query($connection,"UPDATE `khologo` SET 
    `title` = '".$_POST['title']."',
    `gia` = '".$_POST['gia']."',
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form role="form" action="" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">TÊN LOGO:</label>
                                ...
                                <div class="card-footer clearfix">
                                    <a href="listlogo.php" class="btn btn-info">Về Danh Sách Logo</a>
                                </div>
                            </div>
                            <!-- /.card -->
                        </div>
