...
if (isset($_GET['del'])) {
    $del = $_GET['del'];
    echo '<script> if (confirm("Bạn có chắc muốn xoá mẫu web này")) {
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh sách mẫu web</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">mẫu web</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Danh sách mẫu web</h3>
                                    <div class="text-right">
                                        <a class="btn btn-primary btn-icon-left m-b-10" href="add-mau-web.php"
                                            type="button"><i class="fas fa-plus-circle mr-1"></i>Thêm mẫu web</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img class="card-img-top" style="width: 250px;"
                                                            src="<?=$row['img'];?>" alt="<?=$row['title'];?>">
                                                    </td>
                                                    <td><?=$row['gia'];?></td>
                                                    <td><?=$row['gia_han'];?></td>
                                                    <td><?=$row['status'];?></td>
                                                    <td>
                                                        <a href="edit-mau-web.php?id=<?=$row['id'];?>"
