...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="https://tozpie.pw" class="nav-link">Contact</a>
        </li>
    </ul>
...
<aside class="main-sidebar elevation-4" style="background: #111c43;">
    <!-- Brand Logo - Removed -->
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <style>
                    ...
                    .main-sidebar .nav-link.active p {
                        color: #ffffff !important;
                        background-color: rgba(132, 90, 223, 0.3) !important;
                    }
                    ...
                    .main-sidebar .nav-header {
                        color: rgba(163, 174, 209, 0.6) !important;
                        font-size: 0.75rem;
