...
class TelegramBotService
{
    ...
    private function tgRuntimeMessage(int $telegramId, string $message): string
    {
        ...
        'Mã giảm giá không tồn tại.' => 'Giftcode does not exist.',
        'Giftcode đã bị tắt.' => 'Giftcode has been disabled.',
        'Mã giảm giá đã bị tắt.' => 'Giftcode has been disabled.',
        'Giftcode đã hết lượt sử dụng.' => 'Giftcode has no remaining uses.',
        'Mã giảm giá đã hết lượt sử dụng.' => 'Giftcode has no remaining uses.',
        'Giftcode đã hết hạn.' => 'Giftcode has expired.',
        'Mã giảm giá đã hết hạn.' => 'Giftcode has expired.',
        'Giftcode không áp dụng cho sản phẩm này.' => 'This Giftcode does not apply to this product.',
        'Mã giảm giá không áp dụng cho sản phẩm này.' => 'This Giftcode does not apply to this product.',
