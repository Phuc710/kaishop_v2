...
class TelegramBotLocaleVi implements TelegramBotLocaleInterface
{
    private array $map = [
        ...
        'greeting' => "👋 Chào mừng <b>{name}</b> đến với <b>KaiBot</b>! 🤖\n\n━━━━━━━━━━━━━━━━\nChúng tôi cung cấp giải pháp mua sắm tự động, nhanh chóng và bảo mật nhất trên Telegram. 🚀\n\n👇 Chọn chức năng bên dưới để bắt đầu:",
        'language_picker' => "👋 Chào mừng <b>{name}</b> đến với <b>KaiBot</b>! 🤖\n\n━━━━━━━━━━━━━━━━\nNhằm mang lại trải nghiệm tốt nhất, vui lòng chọn ngôn ngữ bên dưới để bắt đầu:",
