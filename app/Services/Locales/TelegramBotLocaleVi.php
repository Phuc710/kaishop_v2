...
class TelegramBotLocaleVi implements TelegramBotLocaleInterface
{
    private array $map = [
        ...
        'greeting' => "🌐 Website chính thức: <b>kaishop.id.vn</b>\n🔐 Dịch vụ OTP: <b>tmail.kaishop.id.vn</b>\n📢 Kênh thông báo: <b>{channel}</b>\n👤 Liên hệ Admin: <b>{admin}</b>\n\n──────────────────────\n👇 Chọn chức năng bên dưới để bắt đầu:",
        'language_picker' => "🌐 Website chính thức: <b>kaishop.id.vn</b>\n🔐 Dịch vụ OTP: <b>tmail.kaishop.id.vn</b>\n📢 Kênh thông báo: <b>{channel}</b>\n👤 Liên hệ Admin: <b>{admin}</b>\n\n──────────────────────\n👇 Chọn ngôn ngữ để bắt đầu:",
        ...
        'gift_input_prompt' => '👇 Vui lòng nhập mã giảm giá:',
        'gift_invalid_title' => '❌ <b>MÃ KHÔNG HỢP LỆ</b>',
        'gift_invalid_msg' => 'Vui lòng kiểm tra lại mã hoặc bấm Quay lại.',
        'gift_button' => '🎟️ Nhập mã',
