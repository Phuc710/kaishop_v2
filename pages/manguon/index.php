...
<head>
    ...
    <title>Mã Nguồn | <?= $chungapi['ten_web']; ?></title>
            ...
            <div class="row">
                <div class="col-md-12 col-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="slider-title">
                                    <h2>Danh sách code của chúng tôi</h2>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <?php
                        $result = mysqli_query($connection, "SELECT * FROM `khocode` WHERE `status`='ON' ORDER BY `id` DESC ");
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <article class="col-xl-3 col-lg-4 col-md-6 mb-4 grid-item category1 category3">
                                ...
                                <div class="gigs-grid">
                                    <div class="gigs-img">
                                        <div class="">
                                            <a href="/ma-nguon/<?= $row['id']; ?>"><img src="<?=asset('assets/images/lazyload.gif')?>"
                                    ...
                                    <div class="gigs-content">
                                        ...
                                        <div class="gigs-title">
                                            <h3>
                                                <a href="/ma-nguon/<?= $row['id']; ?>" class="truncate-2-lines">
                                                    <?= $row['title']; ?> </a>
                                            </h3>
                                        </div>
