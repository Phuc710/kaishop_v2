...
<head>
    ...
    <title>Lịch Sử Tạo Web | <?=$chungapi['ten_web'];?></title>
...
<div class="row">
    <div class="col-md-12">
        <h3 class="text-24 fw-bold text-dark-300 mb-2">LỊCH SỬ TẠO WEB</h3>
                ...
                <table class="w-100 dashboard-table table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-sm text-dark"><p class="text-nowrap"><?=$row['domain'];?></p></td>
                            ...
                            <td class="text-nowrap">
                                <button onclick="location.href='/history-reg-web/<?=$row['id'];?>';" class="btn btn-dark btn-sm">Quản lý</button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
