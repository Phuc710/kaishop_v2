                                ...
                                <div class="profile-info-card">
                                    ...
                                    <div class="profile-info-body bg-white">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control shadow-none" id="tenmien"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control shadow-none" id="ip"
                                                placeholder="Nhập IP host của bạn">
                                        </div>
                                        <div class="mb-3">
        ...
        function thanhtoan() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    xhr.open("POST", BASE_URL + "/ajax/subdomain/process_subdomain.php");
