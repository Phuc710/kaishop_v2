...
// Đếm tổng bản ghi
$total_query = mysqli_query($ketnoi, "SELECT COUNT(*) AS total FROM `history_subdomain` WHERE `username` = '$username'");
$total_row = mysqli_fetch_assoc($total_query);
$total_records = $total_row['total'];
$total_pages = ceil($total_records / $limit);

// Lấy dữ liệu phân trang
$result = mysqli_query($ketnoi, "SELECT * FROM `history_subdomain` WHERE `username` = '$username' ORDER BY `id` DESC LIMIT $start, $limit");
$i = $start + 1;
?>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="w-100">
                <table class="w-100 dashboard-table table text-nowrap">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $result = mysqli_query($ketnoi, "SELECT * FROM `history_subdomain` WHERE `username` = '$username' ORDER BY id DESC");
