        ...
        <div class="col-md-4">
            <div class="card shadow-sm api-sidebar-menu">
                <div class="card-body">
                    ...
                    <div class="bg-light p-3 rounded mb-3">
                        <p><?= $toz_host['name_host'] ?>: <span id="price_item"><?= number_format($gia_host); ?> đ</span></p>
                        <p id="price_month">0 Tháng: <?= number_format($gia_host); ?> đ</p>
                        <p id="totalAmount" class="fw-bold text-danger">Tổng tiền thanh toán: <?= tien($gia_host); ?> đ</p>
